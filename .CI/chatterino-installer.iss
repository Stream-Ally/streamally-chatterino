...
#else
OutputBaseFilename=StreamAllyChatterino.Installer
#endif
Compression=lzma
...
[Icons]
Name: "{autoprograms}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; AppUserModelID: "StreamAlly.Chatterino"
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; AppUserModelID: "StreamAlly.Chatterino"; Tasks: desktopicon
